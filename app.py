...
# CORS: set this to your Amplify URL in App Runner env vars.
# For quick testing you can set CORS_ORIGIN="*"
cors_origin = os.getenv("CORS_ORIGIN", "*")
CORS(app, resources={r"/api/*": {"origins": cors_origin}})

# MongoDB config from env vars
MONGODB_URI = os.getenv("MONGODB_URI")  # required
MONGODB_DB = os.getenv("MONGODB_DB", "webinar_db")
...
def create_message():
    ...
    return jsonify({"id": str(res.inserted_id), **doc}), 201
...
if __name__ == "__main__":
    # Local dev only. App Runner will use gunicorn start command.
